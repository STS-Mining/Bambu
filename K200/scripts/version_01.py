...
def create_arm(angle_deg):
    ...
    coords = [(x * math.cos(angle) - y * math.sin(angle),
...
# HOLES
# =========================================================
def create_hole(radius, x, y):
    hole = cylinder(radius=radius/2, height=THICKNESS + 4, sections=64)
...
ux = ARM_LENGTH * math.cos(upper_angle)
uy = ARM_LENGTH * math.sin(upper_angle)
lx = ARM_LENGTH * math.cos(lower_angle)
ly = ARM_LENGTH * math.sin(lower_angle)
...
# =========================================================
print("Cutting holes...")
final = difference([body, center_hole, end_hole1, end_hole2], engine="manifold")

# =========================================================
# EXPORT
# =========================================================
output_path = Path(SAVE_DIR) / OUTPUT_FILE
output_path.parent.mkdir(parents=True, exist_ok=True)  # Create 'stl' folder if it doesn't exist
