...
UPRIGHT_TOP_RADIUS = 6.0      # round top of upright a little
...
def create_rounded_top_upright():
    ...
    # Extrude gives X/Y profile and Z depth.
    # Rotate so depth becomes local Y and profile height becomes Z.
